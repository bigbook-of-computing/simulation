...
```
--- Explicit FDM Numerical Accuracy Check ---
Analytical BSM Price (S=100): 10.45058
Explicit FDM Price (S=100):   34406929918421983232.00000
Absolute Error:               34406929918421983232.00000
...
**Sample Output:**
```
Stability Ratio (σ²Δt/ΔS²): 0.0001
Ratio is much greater than the stability limit (approx 0.5/1.0), Expecting Blow-Up.
Simulation terminated due to numerical blow-up at time step 12.

--- Explicit FDM Stability Check ---
Time Steps (Nt): 50, Price Steps (Ns): 50
Intentionally Unstable Ratio (σ²Δt/ΔS²): 0.0001

---

Observation: The solution quickly became oscillatory and unstable, producing non-physical negative and excessively large option values.
Conclusion: This confirms the **conditional stability** of the Explicit FDM. For robust financial modeling, unconditionally stable schemes like **Crank–Nicolson** or **Implicit FDM** are mandatory.
```
